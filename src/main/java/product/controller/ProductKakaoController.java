...
public class ProductKakaoController {
	...
	public String kakaobuy(@RequestParam("no")int no ,@RequestParam("pname")String pname, @RequestParam("price")int price,
			...
			String parameter = "cid=TC0ONETIME&partner_order_id=partner_order_id&partner_user_id=partner_user_id&item_name="+pname+"&quantity=1&total_amount="+price+"&vat_amount=200&tax_free_amount=0&approval_url=http://13.209.31.77:8080/realnew/sucessBuy.prd&fail_url=http://13.209.31.77:8080/realnew/buy.prd?no="+no+"&cancel_url=http://13.209.31.77:8080/realnew/buy.prd?no="+no;
