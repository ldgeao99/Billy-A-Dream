    ...
    <div class="row row-cols-2 g-4">
      <div class="col">
        ...
        <label class="btn btn-outline-secondary shadow-none border-0 p-1" for="sidebar-theme-dark">
          <img class="img-thumbnail border-0" src="resources/admin_asset/img/sidebar/sidebar-dark.jpg" alt="sidebar-dark">
        </label>
      </div>
      <div class="col">
        ...
        <label class="btn btn-outline-secondary shadow-none border-0 p-1" for="sidebar-theme-light">
          <img class="img-thumbnail border-0" src="resources/admin_asset/img/sidebar/sidebar-light.jpg" alt="sidebar-light">
        </label>
      </div>
      <div class="col">
        ...
        <label class="btn btn-outline-secondary shadow-none border-0 p-1" for="sidebar-theme-cyan">
          <img class="img-thumbnail border-0" src="resources/admin_asset/img/sidebar/sidebar-cyan.jpg" alt="sidebar-cyan">
        </label>
      </div>
      <div class="col">
        ...
        <label class="btn btn-outline-secondary shadow-none border-0 p-1" for="sidebar-theme-green">
          <img class="img-thumbnail border-0" src="resources/admin_asset/img/sidebar/sidebar-green.jpg" alt="sidebar-green">
        </label>
      </div>
      <div class="col">
        ...
        <label class="btn btn-outline-secondary shadow-none border-0 p-1" for="sidebar-theme-indigo">
          <img class="img-thumbnail border-0" src="resources/admin_asset/img/sidebar/sidebar-indigo.jpg" alt="sidebar-indigo">
        </label>
      </div>
      <div class="col">
        ...
        <label class="btn btn-outline-secondary shadow-none border-0 p-1" for="sidebar-theme-red">
          <img class="img-thumbnail border-0" src="resources/admin_asset/img/sidebar/sidebar-red.jpg" alt="sidebar-red">
        </label>
      </div>
    </div>
  </div>
