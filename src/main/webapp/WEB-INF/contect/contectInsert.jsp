...
<div class="collection-hero">
                        ...
                        <div class="collection-hero__title-wrapper container">
                            <h2 style="font-family: 'Poppins',Arial,Tahoma !important; font-weight: 700!important; font-size:25px;color: black; margin-bottom:0px">문의게시판</h2>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-8 col-lg-8">
                            ...
                            <div class="formFeilds contact-form form-vertical mt-2 mt-md-0">
                                <h1 class="text-center text-capitalize mb-4" style="font-family: 'Poppins' !important">직접 문의 남기기</h1>
