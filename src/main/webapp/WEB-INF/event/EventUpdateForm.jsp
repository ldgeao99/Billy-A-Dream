                    ...
                    <div class="row">
                        <!--Sidebar-->
                                ...
                                <div class="sidebar_widget clearfix">
                                    <div class="widget-title"><h2>안전성</h2></div>
                                    <div class="widget-content">
                                        <p>저희는 소비자와 판매자에 안전한 거래를 위하여 항상 노력하는 모습을 보이겠습니다. 오늘 하루도 좋은 하루 보내세요.</p>
                                    </div>
                                </div>
                                <!--End About Blog-->
                            </div>
...
<b>이벤트 글 수정</b>
	<br>
	<form:form commandName="event" method="post"  enctype="multipart/form-data" action="update.evt">
		...
		<table width="430" border="1"
			...
			<tr>
				...
				<td width="330" align="left">
	             ...
	             <fmt:formatDate var="newformattedDay" value="${formattedDay }" pattern="yyyy-MM-dd"/>
					<input type="text" size="50" maxlength="50" name="eventdate" value="${newformattedDay}">
				</td>
			...
			<img height=100 width=100 src="${pageContext.request.contextPath}/resources/assets/images${event.eventImage}">
				<input type="file" name="upload" id="upload" value="${event.upload }">
			...
			<tr>
				...
				<textarea name="write" id="abc" rows="13" cols="50">${event.write}</textarea>
