...
<script>
	...
	function logout() {
	   location.href="https://kauth.kakao.com/oauth/logout?client_id=712a5c51e06bca8448c4c65b4205bb54&logout_redirect_uri=http://15.165.105.57:8080/out.mb";
	  }
</script>
                    ...
                    <div class="container">        
                        <div class="row">
                            ...
                            <div class="col-6 col-sm-6 col-md-6 col-lg-2 align-self-center justify-content-start d-flex">
                                ...
                                <!--End Mobile Toggle-->
                                <!--Logo-->
                                <div class="logo"><a href="/"><img class="logo-img mh-100" src="resources/assets/images/cloud30.png" alt="Optimal Multipurpose eCommerce Bootstrap 5 Html Template" title="Optimal Multipurpose eCommerce Bootstrap 5 Html Template" /><span class="logo-txt d-none">Optimal</span></a></div>
                                <!--End Logo-->
                            </div>
