						...
						<div style="width: 50%; margin-left: 300px;" >
							...
							<form method="post" action="register.mb" name="f">
											<div class="form-group">
												...
												<input type="text" class="form-control" id="id" name="id" aria-describedby="emailHelp" placeholder="아이디를 입력해주세요" value="${email }" readonly>
											</div>
											...
											<div class="form-group">
												...
												<input type="text" class="form-control" id="name" name="name" aria-describedby="emailHelp" value="${name }" readonly>
											</div>
											<div class="form-group">
											...
											<div class="form-group">
												...
												<input type="email" class="form-control" name="email" id="email"aria-describedby="emailHelp" value="${email }" readonly  >
											</div>
												<br><br>
