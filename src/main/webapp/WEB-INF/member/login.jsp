...
<script type="text/javascript">
	...
	function findId(){
		if ($('#popname').val() == "") {
			$('#namemsg').html("<br><br><font color=red>성함을 입력해주세요</font>");
			$('#namemsg').show();
			return;
		} 
		else if(!AuthClick){
			$('#hpmsg').html("<br><br><font color=red>인증번호 받기를 눌러주세요</font>");
			$('#hpmsg').show();
			return;
		}
		else if($('#authNum').val()==""){
			$('#hpmsg').html("<br><br><font color=red>인증번호 입력해주세요</font>");
			$('#hpmsg').show();
			return;
		}
		else if(!confirm){
			$('#hpmsg').html("<br><br><font color=red>인증번호 확인해주세요</font>");
			$('#hpmsg').show();
			return;
		}
		else {
			$.ajax({
						...
						success : function(data) {
							if($.trim(data)!=null){
							$('#FINDID').html("<br><br><font color=green size=10px>"+$.trim(data)+"</font>");
							$('#FINDID').show();
							}
							else{
							$('#FINDID').html("<br><br><font color=red size=10px>가입되지 않은 회원입니다</font>");
							$('#FINDID').show();
							}
						}//success
	...
	function findPW(){
		if ($('#popid').val() == "") {
			$('#idmsg').html("<br><br><font color=red>아이디를 입력해주세요</font>");
			$('#idmsg').show();
			return;
		} 
		else if(!PWAuthClick){
			$('#hpmsg2').html("<br><br><font color=red>인증번호 받기를 눌러주세요</font>");
			$('#hpmsg2').show();
			return;
		}
		else if($('#authNum2').val()==""){
			$('#hpmsg2').html("<br><br><font color=red>인증번호 입력해주세요</font>");
			$('#hpmsg2').show();
			return;
		}
		else if(!confirm){
			$('#hpmsg2').html("<br><br><font color=red>인증번호 확인해주세요</font>");
			$('#hpmsg2').show();
			return;
		}
		else {
			$.ajax({
						...
						success : function(data) {
							if($.trim(data)!=null){
							$('#FINDPW').html("<br><br><font color=green size=10px>"+$.trim(data)+"</font>");
							$('#FINDPW').show();
							}
							else{
							$('#FINDPW').html("<br><br><font color=red size=10px>가입되지 않은 회원입니다</font>");
							$('#FINDPW').show();
							}
						}//success
...
<!--  ======================================================================================================================================================================== -->
									...
									<div class="row">
										<div class="text-left col-12 col-sm-12 col-md-12 col-lg-12">
											<p class="d-flex-center">
												<input type="button" onclick="return loginCheck()" class="btn rounded me-auto" value="Sign In">
											<a href='#' onClick='showPopupID(true); return false' style="font-size: 6px;">아이디 찾기</a> &nbsp;&nbsp;/&nbsp;&nbsp;
											<a href='#' onClick='showPopupPW(true); return false' style="font-size: 6px;">비밀번호 찾기</a>
											</p>
											...
											<div id="popupID" class="hide">
												<div class="content">
													...
													<div class="row">
														<div
															class="box col-12 col-sm-12 col-md-8 col-lg-6 offset-md-2 offset-lg-3">

															<h3 class="h4 text-uppercase mb-2">아이디 찾기</h3>
															<br>
															<br>

															<p>회원 아이디를 찾기 위해서는 회원명과 휴대전화 인증이 필요합니다</p>
															<div class="row">
																<div
																	...
																	<table>
																		<tr>
																			<td><input type="text" name="name" id="popname"
																				placeholder="성함" class="small"> <span
																				style="display: none;" id="namemsg"></span></td>
																		</tr>
																		<tr>
																			<td><input type="text" name="hp" id="hp"
																				placeholder="전화번호 입력" class="small"></td>
																			<td><input type="button" value="인증번호 받기"
																				onclick="sendSMS()" class="bt"> <span
																				style="display: none;" id="hpmsg"></span></td>
																		</tr>
																		<tr>
																			<td><span style="display: none;" id="hpm"></span>
																			</td>
																		</tr>
																		<tr>
																			<td><input type="text" id="authNum"
																				name="authNum" style="width: 160px;"
																				placeholder="인증번호 입력하세요"></td>
																			<td><input type="button" value="인증번호 확인"
																				onclick="CheckauthNum()" class="bts"><br>
																				<span style="display: none;" id="hpnmsg"></span></td>
																		</tr>
																	</table>
																	<input type="button" value="아이디 찾기" onclick="findId()"><br>
																	<br>
																	<br> <span id="FINDID" style="display: none;"></span>
																	<a href='#' onClick='closePopupID(); return false'><i
																		class="align-middle icon an an-an-double-left me-2"></i>뒤로가기</a>
																	</p>
																</div>
															</div>
														</div>
												...
												<div class="content">
													...
													<div class="row">
														<div
															...
															<h3 class="h4 text-uppercase mb-2">비밀번호 찾기</h3>
															<br>
															<br>

															<p>회원 비밀번호를 초기화하기 위해서는 아이디와 휴대전화 인증이 필요합니다</p>
															<div class="row">
																<div
																	class="text-left col-12 col-sm-12 col-md-12 col-lg-12">
																	<p class="d-flex-center">
																	<table>
																		...
																		<tr>
																			<td>
																				<input type="text" id="authNum" name="authNum2" style="width: 160px;" placeholder="인증번호 입력하세요"></td>
																			<td>
																	...
																	<input type="button" value="비밀번호 초기화" onclick="findPW()"><br>
																	<br>
																	<br> <span id="FINDPW" style="display: none;"></span>
                            ...
                            <div class="col-12 col-sm-12 col-md-6 col-lg-6">
                                <div class="inner">
                                    ...
                                    <a href="register.mb" class="btn rounded">Create an account</a>
                                </div>
                            </div>
                        </div>
                    </div>
