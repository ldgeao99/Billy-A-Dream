...
<html lang="en">
    <head>
        ...
        <!-- Title Of Site -->
        <title>Forgot Your Password - Optimal Multipurpose eCommerce Bootstrap 5 Html Template</title>
        <!-- Favicon -->
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="box col-12 col-sm-12 col-md-8 col-lg-6 offset-md-2 offset-lg-3">
                            <form method="post" action="#" accept-charset="UTF-8" class="customer-form mt-2 mt-lg-5">	
                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-12 col-md-12 col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="customer[email]" placeholder="Email" id="CustomerEmail" required />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="text-left col-12 col-sm-12 col-md-12 col-lg-12">
                                        <p class="d-flex-center">
                                            ...
                                            <a href="login.html"><i class="align-middle icon an an-an-double-left me-2"></i>Back To Login Page</a>
                                        </p>
                                    </div>
                                </div>
                            </form>
