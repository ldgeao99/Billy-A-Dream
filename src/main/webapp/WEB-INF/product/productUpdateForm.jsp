...
<div class="collection-header">
                    <div class="collection-hero">
                        ...
                        <div class="collection-hero__title-wrapper container">
                            <h2 style="font-family: 'Poppins',Arial,Tahoma !important; font-weight: 700!important; font-size:25px;color: black; margin-bottom:0px">상품수정</h2>
                        </div>
                    </div>
                </div>
	...
	<div class="container">
		...
		<div class="row justify-content-md-center">
			...
			<div class="col col-lg-6">
				<input type="text" name="name" placeholder="상품이름을 입력해 주세요(최대 40자)" value="${pb.name}" maxlength="40">
			</div>
		</div>
		...
		<div class="row justify-content-md-center">
			...
			<div class="col col-lg-6">
				<div class="row row-cols-auto">
					...
					<div class="col"><input type="text" name="full_address" placeholder="버튼을 눌러 입력해주세요" value="${pb.add1_sido} ${pb.add2_sigungu} ${pb.add3_eubmyeon} ${pb.add4_donglee}" style="width: 270px" readonly></div>
				...
				<input type="hidden" name="add1_sido" value="${pb.add1_sido}">		<!-- 도/시 이름 --> 
				<input type="hidden" name="add2_sigungu" value="${pb.add2_sigungu}"> 	<!-- 시/군/구 이름 --> 
				<input type="hidden" name="add3_eubmyeon" value="${pb.add3_eubmyeon}"> <!-- 법정리의 읍/면 이름 --> 
				<input type="hidden" name="add4_donglee" value="${pb.add4_donglee}"> <!-- 법정동/법정리 이름 -->
			</div>
		</div>
		<div class="row justify-content-md-center">
			<div class="col col-lg-8">
		...
		<div class="row justify-content-md-center">
			...
			<div class="col col-lg-6">
				<input type="text" name="original_day_price" placeholder="숫자만 입력해주세요" maxlength="8" style="width: 200px" value="${pb.original_day_price}"> 원
			</div>
		</div>
		<div class="row justify-content-md-center">
			<div class="col col-lg-8">
		...
		<div class="row justify-content-md-center">
			...
			<div class="col col-lg-6">
				<input type="text" name="discounted_day_price" placeholder="숫자만 입력해주세요" maxlength="8" style="width: 200px" value="${pb.discounted_day_price}"> 원
			</div>
		</div>
		<div class="row justify-content-md-center">
			<div class="col col-lg-8">
		...
		<div class="row justify-content-md-center">
			...
			<div class="col col-lg-6">
				<input type="text" name="rentday_minimum" placeholder="숫자만 입력해주세요" maxlength="3" style="width: 200px" value="${pb.rentday_minimum}"> 일
			</div>
		</div>
		<div class="row justify-content-md-center">
			<div class="col col-lg-8">
		...
		<div class="row justify-content-md-center">
			...
			<div class="col col-lg-6">
				<textarea name="description" placeholder="내용을 입력해 주세요(최대 300자)" maxlength="300" style="width: 100%; height: 6.25em; resize: none;">${pb.description}</textarea>
			</div>
		</div>
		<div class="row justify-content-md-center">
			<div class="col col-lg-8">
...
( 
	imageView = function imageView(att_zone, btn){ /* ('att_zone', 'btnAtt') 이미지들이 들어갈 위치, 파일추가 버튼 */
		...
		for(var i = 0; i<initialImages.length; i++){
			...
			temp_img.src = "http://localhost:8080/realnew//resources/" + initialImages[i];
