                ...
                <div class="collection-header">
                    <div class="collection-hero">
                        ...
                        <div class="collection-hero__title-wrapper container">
                            <h1 class="collection-hero__title">Vendor Uploads</h1>
                            <div class="breadcrumbs text-uppercase mt-1 mt-lg-2"><a href="index.html" title="Back to the home page">Home</a><span>|</span><span class="fw-bold">Vendor Uploads</span></div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="product-sticky-style mb-4">
                                <div class="card dashboard-profile position-relative">
                                    ...
                                    <div class="list-group rounded-0 dashboard-links">
                                        <a href="vendor-dashboard.html" class="list-group-item list-group-item-action"><i class="an an-home-l me-2"></i> Dashboard</a>
                                        ...
                                        <a href="vendor-uploads.html" class="list-group-item list-group-item-action active"><i class="an an-upload-l me-2"></i> Uploads</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-8">
                                    <form class="row g-3 vendor-upload-detail">
                                        ...
                                        <div class="col-md-6">
                                            <label for="product-categories" class="form-label">Select Categories</label>
                                            <select name="categories" id="product-categories">
                                                ...
                                                <optgroup label="Women">
                                                    <option value="t-shirt">Tops</option>
                                                    <option value="dress">Dress</option>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-color-box d-flex-wrap">
                                                <input class="p-0 border-0 form-control me-2" type="color" id="colorInput1" value="#fe877b" title="Choose your color" />
                                                <input class="p-0 border-0 form-control me-2" type="color" id="colorInput2" value="#ff6191" title="Choose your color" />
                                                <input class="p-0 border-0 form-control me-2" type="color" id="colorInput3" value="#33317d" title="Choose your color" />
                                                <input class="p-0 border-0 form-control me-2" type="color" id="colorInput4" value="#56d4b7" title="Choose your color" />
                                                <input class="p-0 border-0 form-control me-0" type="color" id="colorInput5" value="#009688" title="Choose your color" />
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            ...
                                            <div class="form-checkbox-box d-flex-wrap">
                                                <div class="form-check-inline">
                                                    <div class="customCheckbox"><input type="checkbox" class="form-check-input" id="S" name="size1" value="" /><label for="S">S</label></div>
                                                </div>
                                                <div class="form-check-inline">
                                                    <div class="customCheckbox"><input type="checkbox" class="form-check-input" id="M" name="size2" value="" /><label for="M">M</label></div>
                                                </div>
                                                <div class="form-check-inline">
                                                    <div class="customCheckbox"><input type="checkbox" class="form-check-input" id="L" name="size3" value="" /><label for="L">L</label></div>
                                                </div>
                                                <div class="form-check-inline">
                                                    <div class="customCheckbox"><input type="checkbox" class="form-check-input" id="XL" name="size4" value="" /><label for="XL">XL</label></div>
                                                </div>
                                                <div class="form-check-inline me-0">
                                                    <div class="customCheckbox"><input type="checkbox" class="form-check-input" id="XXL" name="size5" value="" /><label for="XXL">XXL</label></div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-6 col-md-4">
                                            <label class="form-label">Sale Price <span>(In USD)</span></label>
                                            <input type="number" class="form-control" id="price2">
                                        </div>
                                        <div class="col-md-4">
                                            <label class="form-label">Quantity</label>
                                            <input type="number" class="form-control" id="quantity1" required>
                                        </div>
                                        <div class="col-md-12">
                                            <label class="form-label">Product Tags</label>
                                            <div class="form-group m-0">
                                                <input type="text" class="form-control" placeholder="" id="#inputTag" value="" data-role="tagsinput">
