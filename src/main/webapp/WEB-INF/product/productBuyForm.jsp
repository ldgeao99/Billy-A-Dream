                                    ...
                                    <tbody>
                                        <tr class="cart__row border-bottom line1 cart-flex border-top">
                                            ...
                                            <td class="cart__image-wrapper cart-flex-item">
                                                <a href="product-layout1.html"><img class="cart__image blur-up lazyload" data-src="resources/assets/images/products/100x120.jpg" src="resources/assets/images/products/100x120.jpg" alt="Sunset Sleep Scarf Top" width="80" /></a>
                                            </td>
                                        ...
                                        <tr class="cart__row border-bottom line1 cart-flex">
                                            <td class="cart-delete text-center small--hide"><a href="#" class="btn btn--secondary cart__remove remove-icon position-static" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove item"><i class="icon an an-times-r"></i></a></td>
                                            <td class="cart__image-wrapper cart-flex-item">
                                                <a href="product-layout1.html"><img class="cart__image blur-up lazyload" data-src="resources/assets/images/products/100x120.jpg" src="resources/assets/images/products/100x120.jpg" alt="Long Sleeve T-shirts" width="80" /></a>
                                            </td>
                                            <td class="cart__meta small--text-left cart-flex-item">
                                                <div class="list-view-item__title">
                                        ...
                                        <tr class="cart__row border-bottom line1 cart-flex">
                                            <td class="cart-delete text-center small--hide"><a href="#" class="btn btn--secondary cart__remove remove-icon position-static" data-bs-toggle="tooltip" data-bs-placement="top" title="Remove item"><i class="icon an an-times-r"></i></a></td>
                                            <td class="cart__image-wrapper cart-flex-item">
                                                <a href="product-layout1.html"><img class="cart__image blur-up lazyload" data-src="resources/assets/images/products/100x120.jpg" src="resources/assets/images/products/100x120.jpg" alt="Weave Hoodie Sweatshirt" width="80" /></a>
                                            </td>
                                            <td class="cart__meta small--text-left cart-flex-item">
                                                <div class="list-view-item__title">
